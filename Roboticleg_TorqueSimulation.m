...
Solverinterval=Data.TorqueSolverinterval;
 Stime=Data.(combinedname).Stime;
Etime=Data.(combinedname).Etime;
...
if contains(Data.ActiveCoordinates,"Hip_Joint")
    stateWeights.cloneAndAppend(MocoWeight('Hip',StateWeight));    
else
    stateWeights.cloneAndAppend(MocoWeight('Knee',StateWeight));
end
...
CoordinateActuatorName=append('/forceset/',Data.ActiveCoordinates,'_act');
